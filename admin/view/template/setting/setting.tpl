        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-server">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="config_file_extension_allowed" cols="40" rows="5" placeholder="<?php echo $entry_file_mime_allowed; ?>"><?php echo $config_file_extension_allowed; ?></textarea>
