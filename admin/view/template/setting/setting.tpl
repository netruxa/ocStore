          ...
          <div class="tab-pane" id="tab-server">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block"><?php echo $help_seo_url_include_path; ?></span></div>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" for="input-input-seo-url-postfix"><?php echo $entry_seo_url_postfix; ?></label>
              <div class="controls">
