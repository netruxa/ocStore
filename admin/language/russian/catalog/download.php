...
$_['entry_update']     = 'Обновления для существующих клиентов:';

// Help
$_['help_filename']    = 'Вы можете закачать файл через кнопку выбора файла или по FTP, поместив его в папку "download" и введя информацию ниже.<br /><br />Желательно, чтобы имя файла и маска отличались: это не позволит людям получать прямой доступ к файлу, угадав линк.';
$_['help_update']      = 'Отметьте здесь, чтобы обновлять ранее приобретённые версии.';
